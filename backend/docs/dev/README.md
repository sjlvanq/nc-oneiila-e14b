...
| 3 | [Plan-s03](sprints/sprint03.md) | Testing robusto, manejo global de errores y documentación técnica completa. | [Impl.](sprints/sprint03-end.md) |
| 4 | [Plan-s04](sprints/sprint04.md) / [Plan-s04-ext](sprints/sprint04-details.md) | Optimización mediante caché de predicciones, implementación de endpoints analíticos y automatización del despliegue (CI/CD) en OCI. | [Impl](sprints/sprint03-end.md)) |
