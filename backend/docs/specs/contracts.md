...
Response / Error Output: [ErrorStatusResponseDTO.java](https://www.google.com/search?q=/backend/src/main/java/com/churncheck/api/infra/errors/dto/ErrorStatusResponseDTO.java)
