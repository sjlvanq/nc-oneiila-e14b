...
| --- | --- | --- | --- |
| 1 | [Plan-s01](sprints/sprint01.md) | Cimientos y Seguridad: Unificación de búsqueda por DNI, integración de maqueta Iris, arquitectura de AuthContext (JWT) y pantalla de Login. | *En desarrollo* |
| ... | ... | ... | ... |
